  ...
  Cipher.init.overload('int', 'java.security.Key').implementation  = function(opmode, key){
    ...
    console.log("[*] arg key: " + key)
      ...
      if (opmode == 2){
        ...
        //console.log(pub_key["$handle"])
        //Memory.protect(ptr(pub_key["$handle"]),64,'rw-')
        //var keydump = Memory.readByteArray(pub_key["$handle"],32);

        console.log("[*] cast key: "+pub_key.toString());
